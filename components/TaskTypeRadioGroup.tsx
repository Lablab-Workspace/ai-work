...
const types = [
  ...
  },
  {
    id: "inprogress",
    name: "In Progress",
    description: "A task is currently beign worked on",
    color: "bg-yellow-500",
  },
  {
    id: "done",
                  ...
                  <div className="flex w-full items-center justify-between">
                    <div className="flex items-center">
                      <div className="text-sm">
                        <RadioGroup.Label as='p' className={`font-medium ${checked? 'text-white':'text-gray-900'}`}>{type.name}</RadioGroup.Label>
